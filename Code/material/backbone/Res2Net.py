...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # 加载权重值。我们用到的骨架网络是res2net50_v1b_26w_4s
        # Res2Net 所需的权重文件 （已上传至百度网盘），连接如下： 链接：https://pan.baidu.com/s/1Hpazf2A8UkT1nffdMALU2Q?pwd=pyku 提取码：pyku --来自百度网盘超级会员V6的分享
        model_state = torch.load('/home/stu/zy/Inf-Net-master/Snapshots/pre_trained/res2net50_v1b_26w_4s-3cf99910.pth')
        # model_state = torch.load('/root/autodl-tmp/Inf-Net-master/Snapshots/pre_trained/res2net50_v1b_26w_4s-3cf99910.pth')
